...
/// of a hard edge.
/// </summary>
[RequireComponent(typeof(TrackedPlaneVisualizer), typeof(MeshRenderer)/*, typeof(ARPlane)*/)]
public class HWFeatheredPlaneMeshVisualizer : MonoBehaviour {
	...
	void Awake() {
		m_PlaneMeshVisualizer = GetComponent<TrackedPlaneVisualizer>();
		m_FeatheredPlaneMaterial = GetComponent<MeshRenderer>().material;
		//m_Plane = GetComponent<ARPlane>();
	}

	void OnEnable() {
		m_PlaneMeshVisualizer.boundaryChanged += ARPlane_boundaryUpdated;
	}
	...
	void ARPlane_boundaryUpdated() {// (ARPlaneBoundaryChangedEventArgs eventArgs)
		GenerateBoundaryUVs(m_PlaneMeshVisualizer.m_mesh);
	}
	...
	TrackedPlaneVisualizer m_PlaneMeshVisualizer;
